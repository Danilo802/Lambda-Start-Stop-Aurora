...
class TestActionCluster(unittest.TestCase):
    def test_action_cluster(self):
        testar_lambda_handler()
        import lambda_function      
        self.assertEqual(lambda_function.lambda_handler('teste',''),"OK")



def testar_lambda_handler():
